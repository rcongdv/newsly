...
class TestTTSServiceFactory:
    ...
    @patch("app.tts.tts.get_settings")
    @patch("app.tts.tts.TTSServiceFactory.get_service")
    def test_text_to_speech_uses_env_provider(self, mock_get_service, mock_get_settings):
        """Test that text_to_speech reads TTS_PROVIDER from settings."""
    ...
    @patch("app.tts.tts.get_settings")
    @patch("app.tts.tts.TTSServiceFactory.get_service")
    def test_text_to_speech_calls_service(self, mock_get_service, mock_get_settings):
    ...
    @patch("app.tts.tts.get_settings")
    @patch("app.tts.tts.TTSServiceFactory.get_service")
    def test_text_to_speech_returns_service_result(self, mock_get_service, mock_get_settings):
    ...
    @patch("app.tts.tts.get_settings")
    @patch("app.tts.tts.get_elevenlabs_service")
    def test_text_to_speech_with_elevenlabs_integration(self, mock_get_elevenlabs, mock_get_settings):
    ...
    @patch("app.tts.tts.get_settings")
    @patch("app.tts.tts.get_pytts_service")
    def test_text_to_speech_with_pytts_integration(self, mock_get_pytts, mock_get_settings):
